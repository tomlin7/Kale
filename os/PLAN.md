...
## 1. Overview
The `os/` project houses the low-level operating system components written in Kale and x86_64 assembly. It demonstrates Kale running on bare-metal hardware without any host operating system or C runtime.
